package gridPane; // Module-info.java에 exports 추가해줌 or configure로 추가
...
public class MainClass01 extends Application {
	...
	public void start(Stage arg0) throws Exception {
		...
		gridPane.setRowIndex(button,0); //setRowIndex(button,0) = 세로 0번째 배치
		...
		//TextArea ta = new TextArea(); // TextArea -> 텍스트창을 만들어줌
